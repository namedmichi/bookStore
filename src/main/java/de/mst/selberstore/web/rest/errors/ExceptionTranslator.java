...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof de.mst.selberstore.service.EmailAlreadyUsedException ||
            ex instanceof de.mst.selberstore.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof de.mst.selberstore.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "de.mst.selberstore");
    }
}
